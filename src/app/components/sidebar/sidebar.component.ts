...
@Component({
  ...
  imports: [AvatarModule, RouterLink, RouterLinkActive, DashboardIconComponent, TasksIconComponent, CalenderIconComponent, TeamIconComponent, SettingsIconComponent],
